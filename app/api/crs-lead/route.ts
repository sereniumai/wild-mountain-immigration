  ...
  <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #efe6e4;">
    ...
    <tr><td style="padding:22px 26px 4px;">
      <div style="background:#32373c;border-radius:14px;padding:22px 22px 24px;text-align:center;">
        ...
        <p style="margin:8px 0 16px;font-size:13px;color:#cfd3d6;line-height:1.6;">Your first call is free. A licensed RCIC (#R706497) can confirm your real CRS, spot the points you're leaving on the table, and map your route, honestly, with no guarantees about outcomes only IRCC decides.</p>
...
export async function POST(request: Request) {
  ...
  const userText = [
    ...
    "",
    `Want to raise this score? Your first call is free, book a consultation: ${site.url}/contact`,
    "",
