...
import { Phone, PanelLeft, X } from "lucide-react";
...
function SidebarFooter() {
  return (
    <div className="mt-6 rounded-xl border border-line bg-surface/70 p-4">
      ...
      <Link
        href={consult.href}
        className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-lg bg-gradient-to-b from-[#ee100c] to-brand px-3 py-2 text-[13.5px] font-medium text-white shadow-[var(--shadow-brand)] ring-1 ring-inset ring-white/15 transition-transform hover:-translate-y-0.5"
      >
        {consult.label}
      </Link>
