 ...
 * so it stops costing main-thread time / "unused JS" during first paint, which
 * was the largest remaining mobile-performance item.
 *
 ...
 * conversion tags still fire there.
 */
